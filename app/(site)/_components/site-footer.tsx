export function SiteFooter() {
  return (
    <footer className="border-t border-border" lang="en">
      <div className="mx-auto grid min-h-32 w-full max-w-[calc(var(--layout-max)+2*var(--layout-gutter))] grid-cols-[1fr_auto_1fr] items-center gap-4 px-[var(--layout-gutter)] font-mono text-xs leading-body text-muted-foreground [@media(max-width:40rem)]:min-h-36 [@media(max-width:40rem)]:grid-cols-[1fr_auto] [@media(max-width:40rem)]:py-8">
