...
export function AccountProfileSection({
  ...
  return (
    <section
      className="border-b border-border pt-[clamp(4rem,8vw,7rem)] pb-[clamp(4rem,8vw,7rem)]"
        ...
        <div className="rounded-lg border border-border bg-surface-muted p-[clamp(1.5rem,4vw,2.5rem)]">
          <dl className="m-0">
            <div className="border-b border-border pb-6">
              ...
              <dd className="mt-2 ml-0 text-lg font-medium">{name}</dd>
            </div>
            <div className="pt-6">
              <dt
                className="font-mono text-xs leading-body tracking-label text-muted-foreground uppercase"
              ...
              <dd className="mt-2 ml-0 break-all text-lg">{email}</dd>
            </div>
          </dl>
